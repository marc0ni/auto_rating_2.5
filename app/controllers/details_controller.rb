class DetailsController < ApplicationController
  ...
  private
    ...
    def detail_params
      params.require(:detail).permit(:make, :model, :year, :cost_new, :age_group, :territory, :size_class, :load_capacity, :fleet_nonfleet, :spec_causes, :gvw, :gcw, :business_use, :radius_class, :submission_id)
    end
end
