...
class RisksControllerTest < ActionController::TestCase
  ...
  test "should create risk" do
    assert_difference('Risk.count') do
      post :create, risk: { deductible: @risk.deductible, details_id: @risk.details_id, limit: @risk.limit, premium: @risk.premium, risk: @risk.risk, submission_id: @risk.submission_id }
    end
  ...
  test "should update risk" do
    patch :update, id: @risk, risk: { deductible: @risk.deductible, details_id: @risk.details_id, limit: @risk.limit, premium: @risk.premium, risk: @risk.risk, submission_id: @risk.submission_id }
    assert_redirected_to risk_path(assigns(:risk))
  end
