...
class PoliciesControllerTest < ActionController::TestCase
  ...
  test "should create policy" do
    assert_difference('Policy.count') do
      post :create, policy: { policy_no: @policy.policy_no, proposal_id: @policy.proposal_id, submission_id: @policy.submission_id }
    end
  ...
  test "should update policy" do
    patch :update, id: @policy, policy: { policy_no: @policy.policy_no, proposal_id: @policy.proposal_id, submission_id: @policy.submission_id }
    assert_redirected_to policy_path(assigns(:policy))
  end
