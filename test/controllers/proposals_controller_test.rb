...
class ProposalsControllerTest < ActionController::TestCase
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post :create, proposal: { policy_id: @proposal.policy_id, proposal_no: @proposal.proposal_no, submission_id: @proposal.submission_id }
    end
  ...
  test "should update proposal" do
    patch :update, id: @proposal, proposal: { policy_id: @proposal.policy_id, proposal_no: @proposal.proposal_no, submission_id: @proposal.submission_id }
    assert_redirected_to proposal_path(assigns(:proposal))
  end
