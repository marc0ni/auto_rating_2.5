...
class LimitsControllerTest < ActionController::TestCase
  ...
  test "should create limit" do
    assert_difference('Limit.count') do
      post :create, limit: { bipd: @limit.bipd, medical: @limit.medical, submission_id: @limit.submission_id }
    end
  ...
  test "should update limit" do
    patch :update, id: @limit, limit: { bipd: @limit.bipd, medical: @limit.medical, submission_id: @limit.submission_id }
    assert_redirected_to limit_path(assigns(:limit))
  end
