...
class PremiaControllerTest < ActionController::TestCase
  ...
  test "should create premium" do
    assert_difference('Premium.count') do
      post :create, premium: { coll_base: @premium.coll_base, comp_base: @premium.comp_base, otc_base: @premium.otc_base, submission_id: @premium.submission_id }
    end
  ...
  test "should update premium" do
    patch :update, id: @premium, premium: { coll_base: @premium.coll_base, comp_base: @premium.comp_base, otc_base: @premium.otc_base, submission_id: @premium.submission_id }
    assert_redirected_to premium_path(assigns(:premium))
  end
